;;if(typeof ProcessWire=="undefined")ProcessWire={};(()=>{ProcessWire.addHookAfter=addHookAfter;ProcessWire.addHookBefore=addHookBefore;ProcessWire.wire=wire;const hooks={after:{},before:{},};class HookEvent{constructor(data){this.object=data.object;this.args=data.arguments;this.replace=!1;this.return=data.return}
...
function wire(object,name=null,noProxy=!1){if(object.constructor.name!=="Object"){name=object.constructor.name}
